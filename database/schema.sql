...
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public.daily_tasks_template TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public.daily_tasks_instance TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public.score_log TO authenticated;
